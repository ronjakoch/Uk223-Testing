...
public class User {
    ...
    private List<Auction> auctionsOfUser;
    ...
    public List<Auction> getAuctionsOfUser() {
        return auctionsOfUser;
    }

    public void setAuctionsOfUser(List<Auction> auctionsOfUser) {
        this.auctionsOfUser = auctionsOfUser;
    }
}
